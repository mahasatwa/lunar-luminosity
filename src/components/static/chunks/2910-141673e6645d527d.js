  ...
  [2910],
  {
    ...
    12910: (t, e, n) => {
      ...
      var M = n(22341),
        k = n(75854),
        x = n(30663);
      let P = /[yYQqMLwIdDecihHKkms]o|(\w)\1*|''|'(''|[^'])+('|$)|./g,
        S = /P+p+|P+|p+|''|'(''|[^'])+('|$)|./g,
        W = /^'([^]*?)'?$/,
        D = /''/g,
        T = /[a-zA-Z]/;
      function C(t, e, n) {
        var i, u, l, d, s, c, h, m, f, g, w, b, y, p, C, Y, q, N;
        let O = (0, a.q)(),
          E =
            null !==
              (g =
          ...
          H =
            null !==
                ...
                null !==
                  (q =
                    null !==
                      ...
                      ? Y
                      : O.weekStartsOn) && void 0 !== q
                  ? q
                  : null === (m = O.locale) || void 0 === m
                  ? void 0
              ...
              : 0,
          j = (0, o.a)(t);
        if (!(0, x.f)(j)) throw RangeError("Invalid time value");
        let A = e
          .match(S)
          .map((t) => {
            let e = t[0];
            return "p" === e || "P" === e ? (0, M.m[e])(t, E.formatLong) : t;
          })
          .join("")
          .match(P)
          .map((t) => {
        ...
        E.localize.preprocessor && (A = E.localize.preprocessor(j, A));
        let z = { firstWeekContainsDate: F, weekStartsOn: H, locale: E };
        return A.map((r) => {
            ...
            (+(0, a.b)(e) -
              +(function (t) {
                let e = (0, i.p)(t),
                  n = (0, o.w)(t, 0);
                return (
                  n.setFullYear(e, 0, 4), n.setHours(0, 0, 0, 0), (0, a.b)(n)
                );
              })(e)) /
              r.my
          ) + 1
...
//# sourceMappingURL=2910-141673e6645d527d.js.map
