...
const $$Sejarah = createComponent(async ($$result, $$props, $$slots) => {
  ...
  const pageContent = await Astro2.glob(/* #__PURE__ */ Object.assign({"../../data/facts/sejarah-singkat.md": () => import('../../chunks/sejarah-singkat_CGK6Vrpq.mjs')}), () => "../../data/facts/sejarah-singkat.md");
