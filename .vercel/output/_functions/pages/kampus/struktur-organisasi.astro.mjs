...
const $$StrukturOrganisasi = createComponent(async ($$result, $$props, $$slots) => {
  ...
  const pageContent = await Astro2.glob(/* #__PURE__ */ Object.assign({"../../data/facts/struktur-organisasi.md": () => import('../../chunks/struktur-organisasi_sQboP_Bf.mjs')}), () => "../../data/facts/struktur-organisasi.md");
