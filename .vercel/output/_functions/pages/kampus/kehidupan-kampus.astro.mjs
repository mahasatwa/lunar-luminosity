...
const $$KehidupanKampus = createComponent(async ($$result, $$props, $$slots) => {
  ...
  const pageContent = await Astro2.glob(/* #__PURE__ */ Object.assign({"../../data/facts/kehidupan-kampus-ormawa.md": () => import('../../chunks/kehidupan-kampus-ormawa_BjAQOg2s.mjs')}), () => "../../data/facts/kehidupan-kampus-ormawa.md");
