...
const $$BiayaKuliah = createComponent(async ($$result, $$props, $$slots) => {
  ...
  const pageContent = await Astro2.glob(/* #__PURE__ */ Object.assign({"../data/facts/struktur-biaya-kuliah.md": () => import('../chunks/struktur-biaya-kuliah_DV2TerQJ.mjs')}), () => "../data/facts/struktur-biaya-kuliah.md");
