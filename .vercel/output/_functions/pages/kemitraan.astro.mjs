...
const $$Kemitraan = createComponent(async ($$result, $$props, $$slots) => {
  ...
  const pageContent = await Astro2.glob(/* #__PURE__ */ Object.assign({"../data/facts/kemitraan-industri-magang.md": () => import('../chunks/kemitraan-industri-magang_DLPCgsSb.mjs')}), () => "../data/facts/kemitraan-industri-magang.md");
