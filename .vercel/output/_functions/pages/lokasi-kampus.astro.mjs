...
const $$LokasiKampus = createComponent(async ($$result, $$props, $$slots) => {
  ...
  const pageContent = await Astro2.glob(/* #__PURE__ */ Object.assign({"../data/facts/lokasi-aksesibilitas.md": () => import('../chunks/lokasi-aksesibilitas_vjfyBNHB.mjs')}), () => "../data/facts/lokasi-aksesibilitas.md");
