...
const $$Alumni = createComponent(async ($$result, $$props, $$slots) => {
  ...
  const pageContent = await Astro2.glob(/* #__PURE__ */ Object.assign({"../data/facts/profil-alumni-sukses.md": () => import('../chunks/profil-alumni-sukses_BT2IPIld.mjs')}), () => "../data/facts/profil-alumni-sukses.md");
