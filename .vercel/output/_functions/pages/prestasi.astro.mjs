...
const $$Prestasi = createComponent(async ($$result, $$props, $$slots) => {
  ...
  const pageContent = await Astro2.glob(/* #__PURE__ */ Object.assign({"../data/facts/prestasi-mahasiswa.md": () => import('../chunks/prestasi-mahasiswa_CTwbs2pm.mjs')}), () => "../data/facts/prestasi-mahasiswa.md");
