...
const $$Akreditasi = createComponent(async ($$result, $$props, $$slots) => {
  ...
  const pageContent = await Astro2.glob(/* #__PURE__ */ Object.assign({"../data/facts/akreditasi-program-studi.md": () => import('../chunks/akreditasi-program-studi_CkceQ_ii.mjs')}), () => "../data/facts/akreditasi-program-studi.md");
