...
const $$LayananMahasiswa = createComponent(async ($$result, $$props, $$slots) => {
  ...
  const pageContent = await Astro2.glob(/* #__PURE__ */ Object.assign({"../data/facts/layanan-mahasiswa.md": () => import('../chunks/layanan-mahasiswa_B2LC220y.mjs')}), () => "../data/facts/layanan-mahasiswa.md");
