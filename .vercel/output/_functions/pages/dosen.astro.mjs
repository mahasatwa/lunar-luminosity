...
const $$Dosen = createComponent(async ($$result, $$props, $$slots) => {
  ...
  const pageContent = await Astro2.glob(/* #__PURE__ */ Object.assign({"../data/facts/profil-dosen-unggulan.md": () => import('../chunks/profil-dosen-unggulan_bv4y56yW.mjs')}), () => "../data/facts/profil-dosen-unggulan.md");
