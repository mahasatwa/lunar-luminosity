import { a as createComponent, m as maybeRenderHead, b as addAttribute, r as renderTemplate, d as renderComponent, F as Fragment, u as unescapeHTML, c as createAstro, l as renderScript, n as renderHead, e as renderSlot } from './astro/server_B8HYKlh3.mjs';
import 'kleur/colors';
...
const $$SiteHeader = createComponent(($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${maybeRenderHead()}<header${addAttribute(headerClass, "class")}${addAttribute(position, "data-position")} data-astro-cid-6jwomyys> <div class="container mx-auto flex items-center justify-between py-4 px-6" data-astro-cid-6jwomyys> <!-- 
    ...
    --> <p data-astro-cid-6jwomyys>Site Header Content</p> </div> </header> ${renderScript($$result, "/home/user/lunar-luminosity/src/components/organisms/site-header/SiteHeader.astro?astro&type=script&index=0&lang.ts")} `;
...
export { $$Layout as $, $$SiteHeader as a, $$SiteFooter as b };
